...
object BTCPriceTrainerActor {

  def makeAsk() = Random.nextBoolean()  
  
  def props(): Props =
    Props(new BTCPriceTrainerActor())
...
class BTCPriceTrainerActor extends Actor with ActorLogging {
  
    override def receive: Receive = {

        case BTCPriceTrainerActor.StartTraining() => doTraining()
    }
    
    private def doTraining() {
import BTCPriceTrainerActor._          
